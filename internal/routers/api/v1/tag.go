...
//@Failue 400 {object} errcode.Error "请求错误"
//@Failue 500 {object} errcode.Error "内部错误"
...
func (t Tag) Create(c *gin.Context) {
	param := service.GreateTagRequest{}
	response := app.NewResponse(c)
	valid, errs := app.BindAndValid(c, &param)
	if !valid {
...
//@Param name body string false "标签名称"  maxlength(100)
//@Param state body int false "状态" Enums(0,1) default(1)
//@Param modified_by body string false "创建者" minlength(3) maxlength(100)
//@Success 200 {object} model.Tag "成功"
//@Failue 400 {object} errcode.Error "请求错误"
//@Failue 500 {object} errcode.Error "内部错误"
